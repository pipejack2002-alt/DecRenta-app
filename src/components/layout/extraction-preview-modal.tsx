...
const FIELD_LABELS: Record<string, { label: string; casilla?: number; source?: string }> = {
  ...
  "trabajo.aportesSaludObligatorios": { label: "Aportes obligatorios a salud (INCRNGO)", casilla: 33, source: "Art. 56 E.T." },
  "trabajo.aportesPensionObligatorios": { label: "Aportes obligatorios a pensión (INCRNGO)", casilla: 33, source: "Art. 55 E.T." },
  "trabajo.aportesVoluntariosRais": { label: "Aportes voluntarios RAIS (INCRNGO)", casilla: 33, source: "Art. 55 E.T." },
