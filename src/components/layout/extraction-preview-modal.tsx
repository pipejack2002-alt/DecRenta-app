...
const GROUPS: { label: string; icon: string; keys: (keyof typeof FIELD_LABELS)[] }[] = [
  ...
  {
    label: "Patrimonio — Saldos Bancarios y Bienes al 31/12",
    icon: "🏦",
    keys: ["patrimonio.cuentas", "patrimonio.inmuebles", "patrimonio.obligacionesFinancieras"],
  },
  {
    label: "Rentas de Capital",
    icon: "📈",
    keys: ["capital.intereses", "capital.arrendamientos"],
  },
  {
    label: "Otras Cédulas",
    icon: "📂",
