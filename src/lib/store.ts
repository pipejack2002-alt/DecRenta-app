  ...
  persist(
    (set, get) => ({
      ...
      aiSettings: {
        ...
        geminiModel: (typeof window !== "undefined" ? (localStorage.getItem("tributoapp_gemini_model") as any) : null) || "gemini-1.5-flash",
      },
      profiles: [],
    ...
    }),
    {
      ...
      merge: (persisted, current) => {
        ...
        const aiSettings = {
          ...
          geminiModel: (localModel as any) || p?.aiSettings?.geminiModel || current.aiSettings.geminiModel || "gemini-1.5-flash",
        };
